...
extern zx_status_t zx_system_get_features(uint32_t kind, uint32_t features out);

extern zx_status_t zx_cache_flush(void* addr, size_t len, uint32_t options);

extern zx_status_t zx_handle_close(zx_handle_t handle_release_always handle);

extern zx_status_t zx_handle_duplicate(zx_handle_t handle, zx_rights_t rights, zx_handle_t handle_acquire out);

extern zx_status_t zx_handle_replace(zx_handle_t handle_release handle, zx_rights_t rights, zx_handle_t handle_acquire out);
...
extern zx_status_t zx_channel_create(uint32_t options, zx_handle_t handle_acquire out0, zx_handle_t handle_acquire out1);
...
extern zx_status_t zx_socket_create(uint32_t options, zx_handle_t handle_acquire out0, zx_handle_t handle_acquire out1);
...
extern zx_status_t zx_socket_accept(zx_handle_t handle, zx_handle_t handle_acquire out_socket);

extern void zx_thread_exit(void);

extern zx_status_t zx_thread_create(zx_handle_t process, char* name, uint32_t name_len, uint32_t options, zx_handle_t handle_acquire out);
...
extern zx_status_t zx_process_create(zx_handle_t job, char* name, uint32_t name_len, uint32_t options, zx_handle_t handle_acquire proc_handle, zx_handle_t handle_acquire vmar_handle);

extern zx_status_t zx_process_start(zx_handle_t process_handle, zx_handle_t thread_handle, uintptr_t entry, uintptr_t stack, zx_handle_t handle_release arg_handle, uintptr_t arg2);
...
extern zx_status_t zx_job_create(zx_handle_t parent_job, uint32_t options, zx_handle_t handle_acquire out);
...
extern zx_status_t zx_event_create(uint32_t options, zx_handle_t handle_acquire out);

extern zx_status_t zx_eventpair_create(uint32_t options, zx_handle_t handle_acquire out0, zx_handle_t handle_acquire out1);
...
extern zx_status_t zx_port_create(uint32_t options, zx_handle_t handle_acquire out);
...
extern zx_status_t zx_timer_create(uint32_t options, uint32_t clock_id, zx_handle_t handle_acquire out);
...
extern zx_status_t zx_vmo_create(uint64_t size, uint32_t options, zx_handle_t handle_acquire out);
...
extern zx_status_t zx_vmo_clone(zx_handle_t handle, uint32_t options, uint64_t offset, uint64_t size, zx_handle_t handle_acquire out);

extern zx_status_t zx_vmo_set_cache_policy(zx_handle_t handle, uint32_t cache_policy);

extern zx_status_t zx_vmar_allocate(zx_handle_t parent_vmar_handle, size_t offset, size_t size, uint32_t map_flags, zx_handle_t handle_acquire child_vmar, uintptr_t child_addr);
...
extern zx_status_t zx_fifo_create(uint32_t elem_count, uint32_t elem_size, uint32_t options, zx_handle_t handle_acquire out0, zx_handle_t handle_acquire out1);
...
extern zx_status_t zx_vmar_unmap_handle_close_thread_exit(zx_handle_t vmar_handle, uintptr_t addr, size_t len, zx_handle_t handle_release handle);

extern void zx_futex_wake_handle_close_thread_exit(zx_futex_t* value_ptr, uint32_t count, int new_value, zx_handle_t handle_release handle);

extern zx_status_t zx_log_create(uint32_t options, zx_handle_t handle_acquire out);
...
extern zx_status_t zx_debuglog_create(zx_handle_t resource, uint32_t options, zx_handle_t handle_acquire out);
...
extern zx_status_t zx_interrupt_create(zx_handle_t hrsrc, uint32_t options, zx_handle_t handle_acquire out_handle);
...
extern zx_status_t zx_vmo_create_contiguous(zx_handle_t rsrc_handle, size_t size, uint32_t alignment_log2, zx_handle_t handle_acquire out);

extern zx_status_t zx_vmo_create_physical(zx_handle_t rsrc_handle, zx_paddr_t paddr, size_t size, zx_handle_t handle_acquire out);

extern zx_status_t zx_iommu_create(zx_handle_t rsrc_handle, uint32_t type, void* desc, uint32_t desc_len, zx_handle_t handle_acquire out);

extern zx_status_t zx_bti_create(zx_handle_t iommu, uint32_t options, uint64_t bti_id, zx_handle_t handle_acquire out);
...
extern zx_status_t zx_pci_get_nth_device(zx_handle_t handle, uint32_t index, zx_pcie_device_info_t out_info, zx_handle_t handle_acquire out_handle);
...
extern zx_status_t zx_pci_get_bar(zx_handle_t handle, uint32_t bar_num, zx_pci_bar_t* out_bar, zx_handle_t handle_acquire out_handle);

extern zx_status_t zx_pci_map_interrupt(zx_handle_t handle, int32_t which_irq, zx_handle_t handle_acquire out_handle);
...
extern zx_status_t zx_resource_create(zx_handle_t parent_handle, uint32_t kind, uint64_t low, uint64_t high, zx_handle_t handle_acquire resource_out);

extern zx_status_t zx_guest_create(zx_handle_t resource, uint32_t options, zx_handle_t physmem_vmo, zx_handle_t handle_acquire out);
...
extern zx_status_t zx_vcpu_create(zx_handle_t guest, uint32_t options, zx_vaddr_t entry, zx_handle_t handle_acquire out);

extern zx_status_t zx_vcpu_resume(zx_handle_t vcpu, zx_port_packet_t OUT packet);
